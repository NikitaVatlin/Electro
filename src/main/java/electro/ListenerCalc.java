...
public class ListenerCalc implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (item == transfer[0]) {
			if (!"1234567890.\b".contains(arrayTextField[0].getText()) || arrayTextField[0].getText().isEmpty()) {
		...
		if (item == transfer[1]) {
			if (!"1234567890.\b".contains(arrayTextField[1].getText()) || arrayTextField[1].getText().isEmpty()) {
				arrayTextField[1].setText("0");
			}
			if (!"1234567890.\b".contains(arrayTextField[2].getText()) || arrayTextField[2].getText().isEmpty()) {
				arrayTextField[2].setText("0");
			}
			Two_tarif tarif2 = new Two_tarif(Double.parseDouble(arrayTextField[1].getText()),
